...
<p> And here is the HTML code: </p>
<pre>{html}</pre>
<p> Svelte implements this and other apps so simply, neatly, and transparently that, for the foreseeable future, it will remain my goto framework for small, mid-sized, and possibly large applications. </p>