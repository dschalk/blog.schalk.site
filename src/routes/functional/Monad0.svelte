...
<div> In "Monad(6)(v=>v+7)(v=>v*4)(v=>v-10)", the expression "Monad(6)" creates a closure around "x" accessible to the return value, fu(). The expression "foo('stop')" causes foo to return the number held in the closure, 42. </div>
